                ...
                for track_info in audio_info_list:
                    ...
                    if len(track_info) == 7:
                        ...
                        if (track_info[2] == "AAC") or (track_info[2] == "aac"):
                            summary_box_lines_list.append(str(line))
                            ...
                            if track_info[3] == "2.0ch" or track_info[3] == "2.0 ch":
                                summary_box_lines_list.append(str("  " + str(count) + "->" + str(track_info[0]) + ", " + str(track_info[1]) + ", " + "AAC-LC converting" + ", " + str(track_info[3]) + ", " + "128kps" + ", " + str(track_info[4]) + ", " + str(track_info[5]) + ", " + str(track_info[6])))
                            if track_info[3] == "5.1ch" or track_info[3] == "5.1 ch":
                                summary_box_lines_list.append(str("  " + str(count) + "->" + str(track_info[0]) + ", " + str(track_info[1]) + ", " + "AAC-LC converting" + ", " + str(track_info[3]) + ", " + "384kps" + ", " + str(track_info[4]) + ", " + str(track_info[5]) + ", " + str(track_info[6])))
                    #Ok that not so clean and that mechanical but it make no error (That Just a Display)
                    elif len(track_info) == 6:
                        ...
                        if (track_info[2] == "AAC") or (track_info[2] == "aac"):
                            ...
                            if track_info[3] == "2.0ch" or track_info[3] == "2.0 ch":
                                summary_box_lines_list.append(str("  " + str(count) + "->" + str(track_info[0]) + ", " + str(track_info[1]) + ", " + "ACC-LC converting" + ", " + str(track_info[3]) + ", " + "128kps" + ", " + str(track_info[4]) + ", " + str(track_info[5])))
                            if track_info[3] == "5.1ch" or track_info[3] == "5.1 ch":
                                summary_box_lines_list.append(str("  " + str(count) + "->" + str(track_info[0]) + ", " + str(track_info[1]) + ", " + "ACC-LC converting" + ", " + str(track_info[3]) + ", " + "384kps" + ", " + str(track_info[4]) + ", " + str(track_info[5])))
                    #Ok that not so clean and that mechanical but it make no error (That Just a Display)
                    elif len(track_info) == 5:
                        ...
                        if (track_info[2] == "AAC") or (track_info[2] == "aac"):
                            ...
                            if track_info[3] == "2.0ch" or track_info[3] == "2.0 ch":
                                summary_box_lines_list.append(str("  " + str(count) + "->" + str(track_info[0]) + ", " + str(track_info[1]) + ", " + "ACC-LC converting" + ", " + str(track_info[3]) + ", " + "128kps" + ", " + str(track_info[4])))
                            if track_info[3] == "5.1ch" or track_info[3] == "5.1 ch":
                                summary_box_lines_list.append(str("  " + str(count) + "->" + str(track_info[0]) + ", " + str(track_info[1]) + ", " + "ACC-LC converting" + ", " + str(track_info[3]) + ", " + "384kps" + ", " + str(track_info[4])))
